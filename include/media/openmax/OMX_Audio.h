...
typedef enum OMX_AUDIO_PCMTYPE {
	PCM_WAVE     = 0x0001,
	PCM_DVD_AOB  = 0x0010,
	PCM_DVD_VOB  = 0x0100,
	PCM_BD       = 0x1000,
...
/** MTK RAW PCM format description */
typedef struct OMX_AUDIO_PARAM_RAWTYPE {
    OMX_U32 nSize;                    /**< Size of this structure, in Bytes */
    OMX_VERSIONTYPE nVersion;         /**< OMX specification version information */
    OMX_U32 nPortIndex;               /**< port that this structure applies to */
    OMX_U32 nChannels;                /**< Number of channels (e.g. 2 for stereo) */
    ...
    OMX_AUDIO_PCMTYPE eRawType;
	OMX_U32 nChannelAssignment;
    OMX_U32 nPcmFormat;
} OMX_AUDIO_PARAM_RAWTYPE;
...
typedef struct OMX_AUDIO_PARAM_AC3PROFILETYPE
{
    OMX_U32 nSize;                   // Size of this structure in bytes
    OMX_VERSIONTYPE nVersion;        // OMX specification version
    OMX_U32 nPortIndex;              // Port that this structure applies to
    OMX_U16 nChannels;               // Number of channels in the source data
    OMX_U32 nBitRate;                // Bit rate of the source data (use 0 if rate is variable or unknown)
    OMX_U32 nSamplingRate;           // Sampling rate of the source data
} OMX_AUDIO_PARAM_AC3PROFILETYPE;
...
typedef enum ADPCM_FORMAT_TYPE
{
	WAVE_FORMAT_MS_ADPCM = 2,
	WAVE_FORMAT_DVI_IMA_ADPCM = 17
}ADPCM_FORMAT_TYPE;

typedef struct OMX_AUDIO_ADPCMPARAM
{
	OMX_U32 nSize;
	OMX_VERSIONTYPE nVersion;
	OMX_U32 nPortIndex;

	ADPCM_FORMAT_TYPE nFormatTag;
	OMX_U32 nChannelCount;
	OMX_U32 nSamplesPerSec;
	OMX_U32 nBlockAlign;
	OMX_U32 nBitsPerSample;
	OMX_U32 nExtendDataSize;
    unsigned char  pExtendData[256];
}OMX_AUDIO_ADPCMPARAM;
...
typedef enum {
	OMX_AUDIO_FLAC__CHANNEL_ASSIGNMENT_INDEPENDENT = 0, /**< independent channels */
	OMX_AUDIO_FLAC__CHANNEL_ASSIGNMENT_LEFT_SIDE = 1, /**< left+side stereo */
	OMX_AUDIO_FLAC__CHANNEL_ASSIGNMENT_RIGHT_SIDE = 2, /**< right+side stereo */
	OMX_AUDIO_FLAC__CHANNEL_ASSIGNMENT_MID_SIDE = 3 /**< mid+side stereo */
} OMX_AUDIO_FLAC__ChannelAssignment;
...
typedef struct OMX_AUDIO_PARAM_FLACTYPE {
    ...
    OMX_AUDIO_FLAC__ChannelAssignment  channel_assignment ;
    OMX_U64        total_samples;
    OMX_U32        min_framesize;
    OMX_U32        max_framesize;
    OMX_U16        min_blocksize;
    OMX_U16        max_blocksize;
    OMX_U8          bits_per_sample;    /*bits_per_sample*/
    OMX_U8          md5sum[16];

    OMX_BOOL      has_stream_info;      /**/
...
typedef struct OMX_AUDIO_PARAM_APETYPE {
    ...
    OMX_U32         SampleRate;                /**< Sampling rate of the source data.  Use 0 for variable or unknown sampling rate. */
    OMX_S16         fileversion;
    OMX_U16         compressiontype;
    OMX_U32         blocksperframe;
    OMX_U32         finalframeblocks;
    OMX_U32         totalframes;
    OMX_U16         bps;
    OMX_U16         channels;
    OMX_S32         SourceBufferSize;
    OMX_U32         Bitrate;
...
typedef struct OMX_AUDIO_PARAM_ALACTYPE {
	...
	OMX_U32 nChannels;        /**< Number of channels */
    OMX_U32 nSampleRate;      /**< Sampling rate of the source data.*/
    OMX_U32 nBitsWidth;
	OMX_U32 nSamplesPerPakt;
...
typedef struct OMX_MP3_CONFIG_TYPE {
	OMX_U32 nMaxBufFrameNum;//multi-frame limit
} OMX_MP3_CONFIG_TYPE;
/** @} */
